...
<script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?language=es&key=AIzaSyA-AB-9XZd-iQby-bNLYPFyb0pR2Qw3orw">
    </script>
    ...
    <script>
        ...
        function saveData(lat,lng) {
            ...
            var url = 'locations.php?add_location&nombres=' + nombres + '&apellidos=' + apellidos + '&fecha_nacimiento=' + fecha_nacimiento + '&sexo=' + sexo + '&direccion=' + direccion + '&lat=' + lat + '&lng=' + lng + '&cedula=' + cedula + '&convencional=' + convencional + '&celular=' + celular + '&correo=' + correo ;
